Graded 100/100 //not optimal, no comments, but working 100% fine
...
Starting from the smallest partition, write all partitions of the integer n(https://en.wikipedia.org/wiki/Partition_(number_theory)), which parts are prime numbers and the largest part is equal to k. n can be stored in byte
